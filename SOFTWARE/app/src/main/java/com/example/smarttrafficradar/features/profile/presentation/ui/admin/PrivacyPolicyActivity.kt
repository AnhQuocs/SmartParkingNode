...
fun PrivacyPolicyScreen(onBackClick: () -> Unit) {
    Column(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.admin_privacy_title),
            ...
            Text(
                text = stringResource(id = R.string.admin_privacy_intro),
            ...
            PrivacySection(
                title = stringResource(id = R.string.admin_privacy_section_1_title),
                content = stringResource(id = R.string.admin_privacy_section_1_desc)
            )

            PrivacySection(
                title = stringResource(id = R.string.admin_privacy_section_2_title),
                content = stringResource(id = R.string.admin_privacy_section_2_desc)
            )

            PrivacySection(
                title = stringResource(id = R.string.admin_privacy_section_3_title),
                content = stringResource(id = R.string.admin_privacy_section_3_desc)
            )

            PrivacySection(
                title = stringResource(id = R.string.admin_privacy_section_4_title),
                content = stringResource(id = R.string.admin_privacy_section_4_desc)
            )
